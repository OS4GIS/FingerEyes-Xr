...
### Overview
FingerEyes-Xr은 완벽한 웹기반의 높은 수준의 GIS 시스템 개발을 위한 JavaScript 라이브러리이며 HTML5 기술을 웹에서도 기능의 제약을 최소화하여 풍부한(X-Rich) 기능을 사용자에게 제공할 수 있습니다.

### 주요기능
* 다양한 데이터 소스(TMS, WFS, WMS, Custom)를 통한 웹 기반의 빠른 공간 데이터 표출
* 공간 데이터와 연계한 속성 데이터 처리
* Grid, Vector 데이터 기반의 분석
...
* 소스코드에서 저작권자를 식별할 수 있는 정보 제거 또는 변경은 저작권을 침해하는 행위입니다.
* 소프트웨어 저작권에 대한 올바른 준수는 소프트웨어 업계를 발전시키는 매우 중요한 초석입니다. 

### 관련 사이트
* FingerEyes-Xr은 [(주)지오서비스](http://www.geoservice.co.kr)의 지원을 받습니다.
* FingerEyes-Xr은 [GISDEVELOPER.CO.KR](http://www.gisdeveloper.co.kr)를 통해 새로운 소식을 공유합니다.
