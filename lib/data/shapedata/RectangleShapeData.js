...
Xr.data.RectangleShapeData = Xr.Class({
	...
	methods: {
	    ...
	    /* ShapeData */ clone: function () {
            var newThing = new Xr.data.RectangleShapeData(this._mbr.clone());
	        return newThing;
	    },
		...
		/* PointD */ representativePoint: function () {
            var data = this._mbr;
		    return new Xr.PointD(data.centerX(), data.centerY());
		},
	    ...
	    /* String */ type: function () {
	        return Xr.data.ShapeType.RECTANGLE;
	    },
        ...
        /* string */ toWKT: function (/* boolean */ bMulti) {
            ...
            result += mbr.minX + " " + mbr.minY + ", ";
            result += mbr.maxX + " " + mbr.minY + ", ";
            result += mbr.maxX + " " + mbr.maxY + ", ";
            result += mbr.minX + " " + mbr.maxY + ", ";
            result += mbr.minX + " " + mbr.minY;
