...
Xr.layers.GridLayer = Xr.Class({
    ...
    methods: {
        ...
        /* boolean */ densityByValues: function (/* array of object{value: v, x: px, y: py} */ values, /* number */ radius, /* Array */ colorTable,
        ...
        /* boolean */ densityByLayer: function (/* ILayer */ lyr, /* number */ radius, /* Array */ colorTable, /* optinal string */ weightedFieldName,
            ...
            return this.densityByValues(data, radius, colorTable, progressCallback, jsFileName);
