...
Xr.layers.TileMapLayer = Xr.Class({
	...
	methods: {
        connect: function (coordMapper, /* optional function */ callbackFunction) { 
		    ...
		    var reqTile = new Xr.layers.TMSConnectionRequest(url, this._levelDataList, bProxy, onConnectionCompleted, onConnectionFailed);
			reqTile.request();
            ...
            // 연결 호출이 실행되고, 그 호출이 실패했더라고 연결되었다고 처리함
