...
Xr.edit.RectangleSketch = Xr.Class({
    ...
    methods: {
        ...
        /* SVG Element */ createSVG: function (/* CoordMapper */ coordMapper) {
            ...
            var bOK = isFinite(lt.x) && isFinite(lt.y) && isFinite(rb.x) && isFinite(rb.y);
            if (bOK) {
        ...
        mouseDown: function (e) {
	        ...
	        if (this.isNew()) {
                ...
                var mouseDownMapPt = mouseState.snapMapPt;

	            rectMbr.minX = mouseDownMapPt.x;
                rectMbr.minY = mouseDownMapPt.y;
                rectMbr.maxX = mouseDownMapPt.x;
                rectMbr.maxY = mouseDownMapPt.y;
	    ...
	    mouseUp: function (e) {
            ...
            var startPt = coordMapper.V2W(mouseState.downPt.x, mouseState.downPt.y);
            var offsetXY = Xr.OperationHelper.offsetXY(e);
