...
Xr.CoordMapper = Xr.Class({
	...
	construct: 
		CoordMapper = function(viewWidth, viewHeight) {
            ...
            this.mouseState = {
                bDown: false,
                bDrag: false,
                downPt: new Xr.PointD(),
                downScreenPt: new Xr.PointD(),
                downMapSnapPt: new Xr.PointD(),
                downAndMovePt: new Xr.PointD(),
                downAndMoveScreenPt: new Xr.PointD(),
                downAndMoveMapSnapPt: new Xr.PointD(),
	...
	methods: {
        ...
        currentCenter: function (pt) {
            if (arguments.length == 0) {
                return this.V2W(this._viewWidth / 2, this._viewHeight / 2);
            } else {
		...
		moveMapByViewOffset: function(dx, dy) {
